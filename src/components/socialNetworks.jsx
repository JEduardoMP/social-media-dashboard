...
const SocialNetworks = () => {
    return (
        <div className="md:grid md:grid-cols-2 lg:grid-cols-4 xl:gap-x-12">

          {/* Facebook container */}
          <div className="w-10/12 bg-secondary bg-opacity-70 mx-auto py-8 text-gray font-medium rounded border-t-4 border-facebook md:mt-4 xl:w-full">
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="flex mb-4">
                ...
                <p className="pl-2">@nathanf</p>
              </div>
              <h2 className="text-white text-4xl font-bold">1987</h2>
              <p className="uppercase mb-4">F o l l o w e r s</p>
              <p className="flex items-center text-white">
                <svg className="mr-1" xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg>
                12 Today
              </p>
          ...
          {/* Twitter container */}
          <div className="w-10/12 bg-secondary bg-opacity-70 mx-auto py-8 text-gray font-medium rounded border-t-4 border-twitter mt-4 xl:w-full">
            <div className="flex flex-col items-center justify-center">
              ...
              <h2 className="text-white text-4xl font-bold">1044</h2>
              <p className="uppercase mb-4">F o l l o w e r s</p>
          ...
          {/* Instagram container */}
          <div className="relative w-10/12 bg-secondary bg-opacity-70 mx-auto py-8 text-gray font-medium rounded mt-4 xl:w-full">

            <div className="h-topGr absolute w-full top-0 bg-gradient-to-r from-yellow to-pink rounded-t">
            </div>
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <h2 className="text-white text-4xl font-bold">11k</h2>
              <p className="uppercase mb-4">F o l l o w e r s</p>
              <p className="flex items-center text-green">
                <svg className="mr-1" xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fill-rule="evenodd" d="M0 4l4-4 4 4z"/></svg>
                1099 Today
          ...
          {/* Youtube container */}
          <div className="w-10/12 bg-secondary bg-opacity-70 mx-auto py-8 text-gray font-medium rounded border-t-4 border-red-900 mt-4 xl:w-full">
            <div className="flex flex-col items-center justify-center">
              ...
              <h2 className="text-white text-4xl font-bold">8239</h2>
              <p className="uppercase mb-4">S u s c r i b e r s</p>
              <p className="flex items-center text-red-700">
              <svg className="mr-1" xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#DC414C" fill-rule="evenodd" d="M0 0l4 4 4-4z"/></svg>
                144 Today
              </p>
